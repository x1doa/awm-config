                    ...
                    },
                    {
                        ...
                        },
                        {
                            ...
                            direction = 'west',
                            {
                                ...
                                handle_width = dpi(50),
                                handle_shape = require 'helpers'.rrect(10),
...
local function new(args)
    ...
    args.bg = default_value(args.bg or beautiful.bg_normal)
    ...
    args.text_input_bg_color = default_value(args.text_input_bg_color or beautiful.altnormal2)
    args.text_input_text_color = default_value(args.text_input_text_color, "#FFFFFF")
    args.text_input_selection_bg = default_value(args.text_input_selection_bg, beautiful.blue)
    args.text_input_placeholder = default_value(args.text_input_placeholder, "Type to search")

    args.app_normal_color = default_value(args.app_normal_color, beautiful.bg_normal)
